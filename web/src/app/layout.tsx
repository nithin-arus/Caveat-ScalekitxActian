...
export const metadata: Metadata = {
  title: "Caveat — the lawyer in your pocket",
  description:
    "Caveat reads your contract, catches the traps, and writes your response — without your documents ever leaving your control.",
};
    ...
    <html lang="en" className={`${geistSans.variable} ${geistMono.variable} h-full antialiased`}>
      <body className="min-h-full flex flex-col bg-paper text-ink">
        ...
        <footer className="border-t border-ink/10 py-6 text-center text-xs text-ink-muted">
          Caveat — Scalekit × Actian × Render Hackathon, June 27. Running on mock adapters.
        </footer>
      </body>
    </html>
  );
